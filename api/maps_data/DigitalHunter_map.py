...
def plot_map_with_geometry(coords,
                           shapefile_path="api/maps_data/ne_50m_admin_0_countries.shp"):
    ...
    if len(coords) == 1:
        ...
        ax.scatter(x_coords, y_coords, color='green', s=30)  # הצגת הנקודות על הקו
        ax.plot(current_x, current_y, color='blue', linewidth=2, label='current location')
        ax.scatter(current_x, current_y, color='red', s=30)  # הצגת הנקודה האחרונה על הקו
